...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.cls_purchasePayment_btn').on('click', function(e){
			var pendingBalance = $(this).attr('data-pendingBalance');
			var id = $(this).attr('data-id');
			var purchaseNumber = $(this).attr('data-purchaseNumber');
			// alert(pendingBalance);
			$('#pendingBalance').val(pendingBalance);
			$('#purchasePayment').val(pendingBalance);
			$('#purchaseNumber').html(purchaseNumber);
			$('#id').val(id);
		});
	} );
</script>
