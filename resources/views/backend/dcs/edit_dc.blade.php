										...
										<div class="form-group row">
											...
											<div class="col-md-3">
												<div class="row">
													...
													<div class="col-md-12">
														<input type="date" name="issueDate" class="form-control" placeholder="" value="{{$dc->issueDate}}" autocomplete="off">
													</div>
											...
											<div class="col-md-3">
												<div class="row">
													...
													<div class="col-md-12">
														<select id="placeOfSupply" name="placeOfSupply" class="form-control bfh-states" data-country="India" data-state="{{$dc->placeOfSupply}}"></select>
													</div>
																...
																<tbody>
																	...
																	<tr class="product-details-row-scrollable" row-index="{{$dcProduct['dcSerial']}}"> 
																		...
																		<td class="product-detail-cell" id="quantity">
																			<input type="text" class="table-cell-input" id="quantity" name="dcProducts[{{$dcProduct['dcSerial']}}][quantity]" value="{{$dcProduct['quantity']}}">
																		</td>
																		...
																		<td class="product-detail-cell" id="dcDate">
																			<input type="date" class="table-cell-input" id="dcDate" name="dcProducts[{{$dcProduct['dcSerial']}}][dcDate]" value="{{$dcProduct['dcDate']}}">
																		</td>
																		<td class="product-detail-cell" id="vehicleNo">
																			<input type="text" class="table-cell-input" id="vehicleNo" name="dcProducts[{{$dcProduct['dcSerial']}}][vehicleNo]" value="{{$dcProduct['vehicleNo']}}">
																		</td>
