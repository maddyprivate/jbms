	        ...
	        <tbody>			
				<tr class="invoice_for_row no_border">
					@if($invoiceStatus != 'quote')
						...
						@elseif($copy === 'DC')
							<td class="invoice_for" colspan="4"><img src="{{asset('img/invoice/DC.png')}}" height="50px" /></td>
				...
				<tr class="invoice_for_row no_border ">
					<td style="text-align: center;padding-bottom:10px;" colspan="4">Contact on: +020 2999 5561 Or Mail on: jaybhagwanbms@gmail.com</td>
				</tr>
	            <tr>
